...
class ShortTinder extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            index: 0,
    ...
    getShortList = () => {
        axios.get(baseUrl + "Product/GetAllProductsWithStatus?pageNumber=1&pageSize=10&StatusID=2&FilterType=0")
            .then((response) => {
                    ...
                    return (
                        <View style={{ height: "100%" }}>
                            ...
                            <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignSelf: "center", width: "80%", position: "absolute", bottom: 30 }}>
                                ...
                                <TouchableOpacity style={{ height: 50, width: 133, backgroundColor: "#284B46", borderWidth: 1, borderRadius: 60, justifyContent: "center", alignItems: "center", marginTop: "2%" }} ˀ
                                    onPress={() => this.onApproved(item.id)}>
