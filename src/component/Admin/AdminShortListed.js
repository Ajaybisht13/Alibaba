        ...
        return (
            <View style={{ padding: "3%" }} key={item.id}>
                <View style={{ backgroundColor: "white", borderRadius: 10 }}>
                    <View style={{ padding: 10, borderTopWidth: 1, borderLeftWidth: 1, borderRightWidth: 1, borderBottomWidth: 0.1, borderTopLeftRadius: 8, borderTopRightRadius: 8, borderBottomLeftRadius: 10, borderBottomRightRadius: 10, borderBottomColor: "#284B4629", borderLeftColor: "#284B4629", borderRightColor: "#284B4629", borderTopColor: "#D1D1D1", height: "100%" }}>
                        <View style={{}}>
                                    ...
                                    <View style={{}}>
                                        ...
                                        }
                                        {
                                            item.outOfStock == false ?
                                                <TouchableOpacity style={{ alignSelf: "flex-end", backgroundColor: "#FFFFFF", zIndex: 1, marginTop: "3%" }}
                                        ...
                                        item.users.map((item, index) => {
                                            return (
                                                <View style={{ display: "flex", flexDirection: "row" }}>
                                                    ...
                                                    <Text style={{ marginLeft: "2%", fontFamily: "Poppins-SemiBold", fontSize: 14, color: "#2A2539", marginLeft: "5%" }}>{item}</Text>
                                                </View>
                                            )
                                        })
                                    }
                                </ScrollView>
                                {/* <View style={{ display: "flex", alignSelf: "center", width: "88%", position: "absolute", bottom: 10 }}>
                                    <TouchableOpacity style={{ height: 40, width: "40%", borderColor: "#284B46", borderWidth: 1, borderRadius: 60, justifyContent: "center", alignItems: "center", marginTop: "2%", alignSelf: "center" }}
                                        onPress={() => setShowModal(false)}
                                    >
                                        <Text style={{ fontFamily: "Poppins-SemiBold", fontSize: 14, color: "#284B46" }} adjustsFontSizeToFit={true}>Close</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={{ height: 50, width: "40%", backgroundColor: "#284B46", borderWidth: 1, borderRadius: 60, justifyContent: "center", alignItems: "center", marginTop: "2%" }}
                                        onPress={() => onShortList(item.id)}
                                    >
                                        <Text style={{ fontFamily: "Poppins-SemiBold", fontSize: 14, color: "#FFFFFF" }} adjustsFontSizeToFit = {true}>Approved</Text>
                                    </TouchableOpacity>
                                </View> */}
                            </View>
                        </View>
                                            ...
                                            if (i == index) {
                                                return (
                                                    <View style={{ height: "100%" }}>
                                                        ...
                                                        {
                                                            item.outOfStock == false ?
                                                                <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignSelf: "center", width: "88%", marginTop: 600, position: "absolute" }}>
            ...
            <LinearGradient colors={['#FFFFFF', '#F2FDFB']} style={styles.container}>

                {
                    loader ?
                        ...
                        :
                        <View>
                            <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center", width: showfilter == false ? "90%" : "83%", marginTop: "2%", marginLeft: "5%" }}>
                                {
                                    showSearch == true ?
                                        <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                                            <View style={{ flexDirection: "row", width: "92%", alignItems: "center" }}>
                                                <TouchableOpacity onPress={() => navigation.goBack("AdminProduct")}>
                                                    <ArrowLeft name='long-arrow-left' size={22} color="#000000" />
                                                </TouchableOpacity>
                                                <TextInput
                                                    placeholder='Admin Search Product'
                                                    placeholderTextColor={"#585858"}
                                                    style={{ backgroundColor: 'white', fontSize: 15, borderTopWidth: 1, borderBottomWidth: 1, borderColor: "#D1D1D1", width: showfilter == false ? "85%" : "85%", height: 38, borderLeftWidth: 1, borderTopLeftRadius: 6, borderBottomLeftRadius: 6, marginLeft: "2%", paddingLeft: "2%" }}
                                    ...
                                    }
                                    {
                                        showfilter == false ?
                                            ...
                                            <TouchableOpacity onPress={() => {
                                                ...
                                                style={{ marginLeft: "5%" }}>
                                                <FilterIcon name='filter-outline' size={23} color={"#585858"} />
                                            </TouchableOpacity>
                                    }
                ...
                {
                    showCount ?
                        <Text style={{ color: "black", fontFamily: "Poppins-Regular", fontSize: 12, alignSelf: "flex-end", position: "absolute", bottom: Platform.OS == "android" ? "12%" : "13%", marginRight: "10%" }}>{pageCnt.current}/{RecordCount}</Text>
                        : null
                }
            </LinearGradient>
        </SafeAreaView>
