...
const Filter = ({ route }) => {
    ...
    const setMaxYearData = (text) => {
        ...
        else { setLengthError1Max(true); setYearMaxError(true); }
    }
    ...
    const setMaxQtyData = (text) => {
        ...
        else { setLengthError2Max(true); setQtyMaxError(true); }
    }
    ...
    const clearStorage = async () => {
        ...
        const filterDataaa = await AsyncStorage.getItem("filterValue");
        console.log("get from storasge", filterDataaa);
            ...
            for (let j = 0; j < data[i].subItem.length; j++) {
                if (data[i].id == id) {
                    if (i == ind && j == index) {
                        ...
                        console.log("check value1", data[i].subItem[j].isSelected);
                    ...
                    if (data[i].subItem[j].isSelected == true) {
                        if (data[i].subItem[j].filterName == "Custom") {
                            if (dataValue === 1) {
                                ...
                                console.log("data value", minValuedata, maxValuedata);
                            ...
                            if (errorGen == false) {
                                console.log("Error False", minMaxData);
                                let objCustom = {
                                ...
                                data[1].id == dataValue && dataValue == 1 || dataValue == 3 || dataValue == 5 ?
                                    ...
                                    <View>
                                        <View style={{ display: "flex", marginTop: "5%" }}>
                                            ...
                                            {
                                                dataValue == 1 &&
                                                <View style={{ width: "70%", display: "flex", flexDirection: "row", alignItems: "center", marginLeft: "18%", borderWidth: 1, marginTop: "5%", borderRadius: 5, borderColor: lengthErrorMax == false && dataValue == 1 ? (PriceMaxError == false) ? "green" : "black" : "red" }}>
                                                    <View style={{ borderWidth: 0, height: 30, alignItems: "center", justifyContent: "space-between", display: "flex", flexDirection: "row" }}>
                                            ...
                                            {
                                                dataValue == 3 &&
                                                <View style={{ width: "70%", display: "flex", flexDirection: "row", alignItems: "center", marginLeft: "18%", borderWidth: 1, marginTop: "5%", borderRadius: 5, borderColor: lengthError1Max == false && dataValue == 3 ? (YearMaxError == false) ? "green" : "black" : "red" }}>
                                                    <View style={{ borderWidth: 0, height: 30, alignItems: "center", justifyContent: "space-between", display: "flex", flexDirection: "row" }}>
                                                        <Text style={{ color: "black", fontFamily: "Poppins-Medium", marginLeft: "2%" }} adjustsFontSizeToFit={true}> To      :</Text>
                                                    </View>
                                                    <TextInput
                                            ...
                                            {
                                                dataValue == 5 &&
                                                <View style={{ width: "70%", display: "flex", flexDirection: "row", alignItems: "center", marginLeft: "18%", borderWidth: 1, marginTop: "5%", borderRadius: 5, borderColor: lengthError2Max == false && dataValue == 5 ? (QtyMaxError == false) ? "green" : "black" : "red" }}>
                                                    <View style={{ borderWidth: 0, height: 30, alignItems: "center", justifyContent: "space-between", display: "flex", flexDirection: "row" }}>
                                                        <Text style={{ color: "black", fontFamily: "Poppins-Medium", marginLeft: "2%" }} adjustsFontSizeToFit={true}> To      :</Text>
                                                    </View>
                                                    <TextInput
